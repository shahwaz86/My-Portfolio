...
const Navbar = () => {
  ...
  return (
    ...
    <div >
        <h1 className='text-2xl font-bold text-white'>Shahwaz</h1>
    </div>

    <div className='block lg:absolute lg:left-1/2 lg:transform lg:-translate-x-1/2'>
        <button className='text-white text-3xl focus:outline-none' onClick={() => setMenuOpen(true)} 
